...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference('Publication.count') do
      post publications_url, params: { publication: { code: @publication.code, date: @publication.date, p_type: @publication.p_type, title: @publication.title } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { code: @publication.code, date: @publication.date, p_type: @publication.p_type, title: @publication.title } }
